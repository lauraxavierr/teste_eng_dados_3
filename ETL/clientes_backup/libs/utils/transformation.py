...
class Transformation():
    ...
    def read_csv(self, spark: SparkSession) -> DataFrame:
        ...
        df = (
            ...
            #.repartition(2) #partição lógica; Dessa forma garantimos que o processamento não fique restrito a apenas 1 executor
        )
    ...
    def transform_bronze(self, df:DataFrame) -> DataFrame:
        ...
        df = df.withColumn("nm_cliente", upper(col("nm_cliente"))).withColumn("anomesdia", date_format(current_date(), "yyyyMMdd"))
